...
public class Test_MSA_microflow {
	...
	@Test
	public void f_MSA_microflow() throws InterruptedException{
		...
		driver.findElement(By.xpath(prop1.getProperty("w3_task_ss"))).click();
		...
		Thread.sleep(3000);
		//select Hosting as type of bid
		driver.findElement(By.id(prop1.getProperty("w3_t_bid_hosting"))).click();
		...
		body.sendKeys("Test MSA microflow");
		...
		//Click on Submit button
		WebElement myDynamicElement = (new WebDriverWait(driver, 10)).until(ExpectedConditions.presenceOfElementLocated(By.xpath(prop1.getProperty("w3_t_summary_submit2"))));
		...
		System.out.println("Step 2 - from MSA check to MSA complete");
		...
		owait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(prop1.getProperty("w3_t_submitted_msa_check"))));
		...
		//To Approve the registration (MSA complete to Approve)
		
		//click on apply button
		driver.findElement(By.xpath(prop1.getProperty("w3_t_apply_button2"))).click();
		
		//Verify the status of Task as MSA complete
		...
		owait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(prop1.getProperty("w3_t_msa_complete_review"))));
				
			System.out.println("Welcome to MSA complete Review page");
		...
		//open comments section
			...
			System.out.println("The registration is Submitted (using MSA microflow)");
