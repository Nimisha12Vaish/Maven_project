...
public class Test_GPP_Validation_Power_System extends Login {
	...
	public void startBrowser()
	{
	 ...
	 @Test
  public void gpp_validation() throws Exception {
	  ...
	  JavascriptExecutor jse = (JavascriptExecutor)driver;
	    ...
	    WebElement element = wait.until(
	            ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@id='brandFilter1']")));
	    driver.findElement(By.xpath("//input[@id='brandFilter1']")).click();
	    Thread.sleep(12000);
	  ...
	  if( driver.findElement(By.id(prop2.getProperty("Select_GPP_NO"))).isSelected())
	  {
		...
		jse.executeScript("arguments[0].click();", element2);
		 // wait.until(
		  ...
		  System.out.println("Select GPP as yes");
	  }
	 ...
	 // driver.findElement(By.id(prop2.getProperty("BP_Submit_button"))).click();
	  ...
	  //System.out.println("form is not able to submit because of wrong GPP values");
